...
public class ExperienciaController {
    ...
    public ResponseEntity <?> create (@RequestBody ExperienciaDto experienciaDto){
        ...
        if (StringUtils.isBlank(experienciaDto.getCargo()))        
         ...
         Experiencia experiencia = new Experiencia (experienciaDto.getEmpresa(), experienciaDto.getCargo(), experienciaDto.getPeriodo(), experienciaDto.getDescricion(), experienciaDto.getLogo());
